...
def adcreative_for_photo(Link):
   fields = []
   params = {
    'name': input('Enter adcreative name'),
    'object_story_spec': {
    'page_id':page_ID,
    'link_data':{'image_hash':hashed_id,
    'link': Link,
    'message':'Ad'}},
    }
...
if __name__=="__main__":
    ...
    objective=input('Enter objective for your campaign')
    campaign(cname,objective)
    ...
    creative_id=adcreative_for_photo(Link)
    ads_value()
